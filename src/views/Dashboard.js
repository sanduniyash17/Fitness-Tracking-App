  ...
  useEffect(() => {  
    ...
    if (token) {
      try {
        ...
        // Update the way you extract the username from the nested structure
        setUsername(decodedToken.user.username);
        setLoading(false);
  
        console.log('Logged Username:', decodedToken.user.username);
      } catch (error) {
                ...
                <Row>
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Welcome, {username}!</p>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
